...
type Deleter func(ctx observ.ProxyContext, path string) error
...
func Delete(ctx observ.ProxyContext, module, version string, delete Deleter, timeout time.Duration) error {
