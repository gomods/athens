...
build-ver: ## build the athens proxy with version number
	GO111MODULE=on CGO_ENABLED=0 go build -ldflags "-X github.com/gomods/athens/pkg/build.version=$(VERSION) -X github.com/gomods/athens/pkg/build.buildDate=$(DATE)" -o athens ./cmd/proxy
