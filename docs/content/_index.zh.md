...
然后，设置你的 `GOPROXY` 并 `go get` !

    export GOPROXY=http://localhost:3000 && go get module@v1

#### Athens 做了什么？

Athens 为你运行 [Go 模块](https://github.com/golang/go/wiki/Modules) 提供服务。它可以为你提供公有和私有的代码，因此，你不需要直接从 GitHub 或 GitLab 等版本控制系统（VCS）上拉取。
...
**[喜欢本项目吗？现在尝试一下 Athens 吧！](/zh/try-out)**
