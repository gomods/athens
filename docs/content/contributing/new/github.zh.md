...
我们使用 [GitHub](https://github.com) 来托管仓库的远程副本，跟踪 [问题](https://github.com/gomods/athens/issues) 并管理 [Pull Requests](https://github.com/gomods/athens/pulls)。如果您还没有注册，请现在就花一分钟去注册。我们会在您回来时在这里等您。

#### 问题

在 GitHub 上，我们用"问题"来记录代码库中需要的每项变更。包括想法、错误、功能请求、支持请求，甚至只是讨论。
...
请先花一分钟阅读这篇关于创建和维护项目 fork 的精彩帖子（https://kbroman.org/github_tutorial/pages/fork.html）。它还介绍了如何将其他协作者的 fork 添加为远程，这在您开始与其他贡献者合作时会发现很有用。
...
您至少可以期待一些评论，请不要因此气馁。我们都在努力帮助彼此写出尽可能好的代码和文档，所有批评都应被认为是建设性的。
...
在 fork 上创建分支并完成更改后，请确保所有测试仍然通过，详情请参阅 [DEVELOPMENT.md](https://github.com/gomods/athens/blob/main/CONTRIBUTING.md#verify-your-work)。然后将所有更改推送到您的 fork 后，前往 [Athens](https://github.com/gomods/athens) 打开 Pull Request。通常在您推送新分支并访问原始仓库后，GitHub 会提示您打开新的 Pull Request。否则您可以从仓库的 `Pull Requests` 选项卡执行此操作。
